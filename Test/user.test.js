...
//   beforeEach(async () => {
//     await User.deleteMany({ email: { $in: ["pompom@example.com", "testuser@example.com"] } });
//   });
...
//   await User.deleteMany({ email: "awaz@gmail.com" }); // Cleanup to avoid duplicate key errors
